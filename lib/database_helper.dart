...
class DatabaseHelper {
  //all this just creates a database codes are available in flutter database doc
  ...
  Future<int> insertTask(Task task) async {
    //here insertask is a method which will add tasks that to be done
    int taskId = 0;
  ...
  Future<void> updateTaskDiscription(int id, String description) async {
    Database _db = await database();
    await _db.rawUpdate(
